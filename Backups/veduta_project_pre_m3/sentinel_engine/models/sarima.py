# ==================================================
# FILE: streamlit_sandbox/models/sarima.py
# MODEL: SARIMA (Fixed Seasonal Order)
# STATUS: VEDUTA ENGINE � NO AUTO SELECTION
# ==================================================
...
def run_sarima(df: pd.DataFrame, horizon: int, confidence_level: float) -> ForecastResult:
    ...
    if inferred not in ("MS", "M"):
        raise ValueError("SARIMA requires monthly frequency.")
