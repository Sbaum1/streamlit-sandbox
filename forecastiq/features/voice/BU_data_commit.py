...
def render_data_commit_checkpoint():
    ...
    - Appears once per dataset commit
    ...
    # Only render once per dataset commit
    if st.session_state[SESSION_KEYS["shown"]]:
        return
