...
This prevents overconfident forecasts from entering the ensemble with high weight.
        ...
        st.markdown("""
        <div class="tier-grid">
          <div class="tier-card" style="border-color:#6BAF8533">
            <div class="tier-emoji">🟢</div>
            <div class="tier-name" style="color:#6BAF85">Elite</div>
          ...
          <div class="tier-card" style="border-color:#C4585833">
            <div class="tier-emoji">🔴</div>
            <div class="tier-name" style="color:#C45858">Fail</div>
    ...
    with nav[8]:
        ...
        metrics = [
            ("MASE", "Mean Absolute Scaled Error. The primary certification metric. "
             ...
             "MASE < 1.0 = beats seasonal naïve. MASE < 0.70 = beats naive by 30%+. "
...
VEDUTA is powered by the Foresight Engine v1.0.
